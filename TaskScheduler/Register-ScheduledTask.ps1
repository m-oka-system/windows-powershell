...
$action = New-ScheduledTaskAction -Execute $excute -Argument "-Command "C:\OneDrive\DS218j\cloud\azure\windows-powershell\Remove-Item-specified-number-of-days.ps1""
